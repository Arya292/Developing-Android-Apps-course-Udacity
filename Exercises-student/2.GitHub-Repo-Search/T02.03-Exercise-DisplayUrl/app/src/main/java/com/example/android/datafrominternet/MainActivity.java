...
public class MainActivity extends AppCompatActivity {
    ...
    // done Create a method called makeGithubSearchQuery
    // done (3) Within this method, build the URL with the text from the EditText and set the built URL to the TextView
      public void makeGithubSearchQuery(){
        String github_url = mSearchBoxEditText.getText().toString();
          URL githubSearchUrl = NetworkUtils.buildUrl(github_url);
