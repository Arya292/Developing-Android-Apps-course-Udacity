...
public class MainActivity extends AppCompatActivity {
    ...
    if(savedInstanceState !=null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY))
    {
            ...
            String lifecycleDisplayTextViewContents = savedInstanceState
                    .getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(lifecycleDisplayTextViewContents);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String texts = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY , texts);
    }
